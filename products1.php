...
/* Hover specific for Wishlist */
.product-link:hover {
  background-color: #f8f9fa;
  border-color: #adb5bd;
}

/* Hover specific for Add to Cart */
.add-to-cart:hover {
  background-color: #218838;
}

/* Active state */
.product-link:active, .add-to-cart:active {
  transform: translateY(1px);
}

/* Focus state for accessibility */
.product-link:focus, .add-to-cart:focus {
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="bestSellingSlider">
        ...
        <div class="product-card">
          ...
          <button class="add-to-cart" data-product-id="1" data-product-name="Beauty of Joseon" data-product-price="1249">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="2" data-product-name="CBD Calming Relief Serum" data-product-price="2899">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="3" data-product-name="Cica-Calming Recovery Cream" data-product-price="2499">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="4" data-product-name="Cucumber Cooling Gel Mask" data-product-price="1799">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="5" data-product-name="Charcoal Detox Purifying Toner" data-product-price="1599">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="6" data-product-name="Berry Tinted Lip Oil" data-product-price="1199">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="7" data-product-name="Green Tea Clarifying Toner" data-product-price="1549">Add to Cart</button>
        </div>
        ...
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="8" data-product-name="Japan Sakura" data-product-price="1649">Add to Cart</button>
        </div>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="newLaunchesSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="1" data-product-name="Hyaluronic Hydra Boost Serum" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="2" data-product-name="Hyphen Matte Max" data-product-price="1549">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="3" data-product-name="Peptide Plump Pillow Cream" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="4" data-product-name="Lava Scrub Exfoliating Mask" data-product-price="1299">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="5" data-product-name="Vanilla Sugar Lip Scrub" data-product-price="999">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/toner/1025 Dokdo Toner.jpeg" alt="Green Tea Clarifying Toner" class="product-image">
          <h4>Green Tea Clarifying <br>Toner</h4>
          ...
          <p>Reduces shine and minimizes pores <br>with antioxidant-rich green tea</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="6" data-product-name="Green Tea Clarifying Toner" data-product-price="1549">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="7" data-product-name="Gold Radiance Illuminating Cream" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="8" data-product-name="Niacinamide Blemish Control Serum" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="serumsSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="1" data-product-name="Hydra-Sooth Milky Cleanser" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="2" data-product-name="Green Tea Purifying Foam Cleanser" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="3" data-product-name="Charcoal Detox Gel Cleanser" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="4" data-product-name="Vitamin C Brightening Wash" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="5" data-product-name="AHA/BHA Exfoliating Cleanser" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="6" data-product-name="Cica Repair Foaming Cleanser" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="7" data-product-name="Oil-to-Milk Makeup Melter" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="8" data-product-name="Probiotic Balance Cleanser" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="serumsSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="9" data-product-name="Glow Drops Vitamin C Serum" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/serum/serum2.jpg" alt="Natural Lipstick" class="product-image">
          <h4>Hyaluronic Hydra <br>Boost Serum</h4>
          ...
          <p>Deeply plumps and hydrates skin <br>with hyaluronic acid for a dewy finish.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="10" data-product-name="Hyaluronic Hydra Boost Serum" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="11" data-product-name="Retinol Renewal Night Serum" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/serum/serum4.jpg" alt="Bamboo Brush" class="product-image">
          <h4>Niacinamide Blemish <br>Control Serum</h4>
          ...
          <p>Reduces redness, acne, and <br>pores with calming niacinamide.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="12" data-product-name="Niacinamide Blemish Control Serum" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="13" data-product-name="Peptide Firming Complex Serum" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="14" data-product-name="AHA Exfoliating Glow Serum" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/serum/serum7.jpg" alt="Face Serum" class="product-image">
          <h4>CBD Calming <br>Relief Serum</h4>
          ...
          <p>Soothes irritation and redness <br>with anti-inflammatory CBD.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="15" data-product-name="CBD Calming Relief Serum" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="16" data-product-name="Brightening Tranexamic Acid Serum" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="sunscreenSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="17" data-product-name="Looks&MEII UV Protection Moist Peach Sun Cream" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/sunscreen/Hyphen Matte Max Velvet Touch Sunscreen.jpeg" alt="Natural Lipstick" class="product-image">
          <h4>Hyphen Matte Max</h4>
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="18" data-product-name="Hyphen Matte Max Velvet Touch Sunscreen" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="19" data-product-name="LabNo Vegan Water Moist Sun Cream" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="20" data-product-name="Beauty of Joseon Relief Sun Rice & Probiotics Sunscreen" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/sunscreen/Sakura Sunscreen Cream Spf50.jpeg" alt="Clay Mask" class="product-image">
          <h4>Japan Sakura</h4>
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="21" data-product-name="Japan Sakura Spf 50 Essence Cream" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="22" data-product-name="ISNTREE Yam Root Milk Tone Up Sun Cream" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="23" data-product-name="ISNtree Purple Protector Onion Newpair Sunscreen" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="24" data-product-name="DEleventh Aqueous and Non-Greasy Sunscreen Cream" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="moisturizerSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="25" data-product-name="Dew Dream Hydrating Gel Cream" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="26" data-product-name="Midnight Recovery Overnight Mask" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="27" data-product-name="Cloud Cushion Silk Moisturizer" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="28" data-product-name="Green Tea Oil-Free Moisturizer" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/moisturizer/download (11).jpeg" alt="Clay Mask" class="product-image">
          <h4>Gold Radiance <br>Illuminating Cream</h4>
          ...
          <p>Vitamin E and light-reflecting <br>pearls for a lit-from-within glow.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="29" data-product-name="Gold Radiance Illuminating Cream" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="30" data-product-name="Barrier Repair Balm" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/moisturizer/Sensitive Moisturiser.jpeg" alt="Face Serum" class="product-image">
          <h4>Cica-Calming <br>Recovery Cream</h4>
          ...
          <p>Soothes redness and irritation <br>with tiger grass and panthenol.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="31" data-product-name="Cica-Calming Recovery Cream" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/moisturizer/The Best Moisturizer for Dry Skin.jpeg" alt="Mascara" class="product-image">
          <h4>Peptide Plump Pillow <br>Cream</h4>
          ...
          <p>Firms while it hydrates with <br>collagen-boosting peptides.</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="32" data-product-name="Peptide Plump Pillow Cream" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="faceMasksSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="33" data-product-name="Charcoal Detox Clay Mask" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="34" data-product-name="Honey Glow Smoothing Mask" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="35" data-product-name="Matcha Green Tea Calming Mask" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="36" data-product-name="Overnight Hydra-Sleep Mask" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="37" data-product-name="Pore Refining AHA Peel Mask" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="38" data-product-name="Rose Quartz Radiance Mask" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/face mask/The Best Korean Face Mask for Your Skin Type to Get ‘Glass Skin’.jpeg" alt="Cucumber Cooling Gel Mask" class="product-image">
          <h4>Cucumber Cooling <br>Gel Mask</h4>
          ...
          <p>Depuffs and refreshes tired skin <br>with a burst of hydration</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="39" data-product-name="Cucumber Cooling Gel Mask" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/face mask/✨✨✨.jpeg" alt="Lava Scrub Exfoliating Mask" class="product-image">
          <h4>Lava Scrub Exfoliating <br>Mask</h4>
          ...
          <p>Gently buffs away impurities <br>with volcanic ash and enzymes</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="40" data-product-name="Lava Scrub Exfoliating Mask" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="tonerSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="41" data-product-name="Rosewater Hydrating Mist" data-product-price="1799">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/toner/1025 Dokdo Toner.jpeg" alt="Green Tea Clarifying Toner" class="product-image">
          <h4>Green Tea Clarifying <br>Toner</h4>
          ...
          <p>Reduces shine and minimizes pores <br>with antioxidant-rich green tea</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="42" data-product-name="Green Tea Clarifying Toner" data-product-price="1399">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="43" data-product-name="AHA/BHA Exfoliating Toner" data-product-price="2199">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="44" data-product-name="Cica Rescue Soothing Toner" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="45" data-product-name="Hyaluronic Plumping Toner" data-product-price="1499">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/toner/Peach Serum Tightens (2 pieces).jpeg" alt="Charcoal Detox Purifying Toner" class="product-image">
          <h4>Charcoal Detox <br>Purifying Toner</h4>
          ...
          <p>Draws out impurities with <br>activated charcoal and witch hazel</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="46" data-product-name="Charcoal Detox Purifying Toner" data-product-price="1699">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="47" data-product-name="Vitamin C Brightening Toner" data-product-price="2599">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="48" data-product-name="Lavender Moonlight Calming Toner" data-product-price="1249">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
    ...
    <div class="product-slider-container">
      ...
      <div class="product-slider" id="lipCareSlider">
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="49" data-product-name="SPF 30 Lip Shield" data-product-price="899">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="50" data-product-name="CBD Comfort Lip Serum" data-product-price="699">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/lip care/preppy laneige.jpeg" alt="Vanilla Sugar Lip Scrub" class="product-image">
          <h4>Vanilla Sugar <br>Lip Scrub</h4>
          ...
          <p>Gently exfoliates with sugar crystals <br>while vanilla extract conditions</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="51" data-product-name="Vanilla Sugar Lip Scrub" data-product-price="1099">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="52" data-product-name="Honey Butter Lip Mask" data-product-price="549">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="53" data-product-name="Matte Lip Treatment Stick" data-product-price="749">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="54" data-product-name="Peppermint Plump Balm" data-product-price="849">Add to Cart</button>
        </div>
        <div class="product-card">
          ...
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="55" data-product-name="Coconut Luxe Lip Sleeping Mask" data-product-price="1299">Add to Cart</button>
        </div>
        <div class="product-card">
          <img src="media/lip care/Gisou _ Honey infused haircare from the Mirsalehi Bee Garden.jpeg" alt="Matte Lip Treatment Stick" class="product-image">
          <h4>Berry Tinted Lip <br>Oil</h4>
          ...
          <p>Sheer wash of color with <br>jojoba oil for glossy, hydrated lips</p>
          <button class="product-link">Wishlist</button>
          <button class="add-to-cart" data-product-id="56" data-product-name="Berry Tinted Lip Oil" data-product-price="649">Add to Cart</button>
        </div>
      </div>
      <button class="slider-nav next" aria-label="Next products">
        <i class="fas fa-chevron-right"></i>
...
function addToCart(productId, productName, productPrice, productImage) {
    ...
    if (existingItem) {
        ...
        cart.push({
            ...
            quantity: 1,
            image: productImage // Add this line
        });
    }
...
const cartIconLink = document.querySelector('.bi-cart-check');
if (cartIconLink) {
    cartIconLink.closest('a').addEventListener('click', function(e) {
        e.preventDefault();
        openCartPage();
    });
}
...
// Cart icon click to open cart page
